...
//        txtTongTien.setText("" + tong);
    ...
    public HoaDonMODEL taohdcho() throws ParseException {
        ...
        DecimalFormat df = new DecimalFormat("#,###.##");
        float floatTienHang = Float.parseFloat(df.parse(txttongtienhang.getText()).toString());
        float floatTienphaitra = Float.parseFloat(df.parse(txttienphaitra.getText()).toString());
        ...
        h.setTienPhaiTra(floatTienphaitra);
...
//    }
    ...
    private void initComponents() {
        ...
        jPaneTrangChuLayout.setHorizontalGroup(
            ...
            .addGroup(jPaneTrangChuLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtid, javax.swing.GroupLayout.DEFAULT_SIZE, 1245, Short.MAX_VALUE))
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPaneTrangChu, javax.swing.GroupLayout.DEFAULT_SIZE, 1255, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPaneTrangChu, javax.swing.GroupLayout.PREFERRED_SIZE, 791, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton64ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton64ActionPerformed
        ...
        String password = JOptionPane.showInputDialog(null, "Nhập mật khẩu:", "Nhập mật khẩu để vào QL Nhân Viên", JOptionPane.PLAIN_MESSAGE);

        if (password != null) {
            if (password.equals("123456")) {
                JOptionPane.showMessageDialog(null, "Chào bạn đến với Quản Lý Nhân Viên",
                ...
                JOptionPane.showMessageDialog(null, "Mật khẩu không đúng. Vui lòng thử lại.",
                        "Xác nhận thất bại", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jButton70ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton70ActionPerformed
        String password = JOptionPane.showInputDialog(null, "Nhập mật khẩu:", "Nhập mật khẩu để vào Thống Kê", JOptionPane.PLAIN_MESSAGE);

        if (password != null) {
            if (password.equals("123456")) {
                JOptionPane.showMessageDialog(null, "Chào bạn đến với Quản Lý Thống kê",
                        "Xác nhận thành công", JOptionPane.INFORMATION_MESSAGE);
