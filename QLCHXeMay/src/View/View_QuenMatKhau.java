...
public class View_QuenMatKhau extends javax.swing.JFrame {
    ...
    public String ranDomCaptcha() {//tạo một mã Captcha ngẫu nhiên.
        Random random = new Random();
        int captcha = random.nextInt(100000, 1000000);//gọi phương thức nextInt(int bound) của đối tượng Random để tạo một số nguyên ngẫu nhiên trong khoảng từ 100000 đến 999999
        return String.valueOf(captcha);//phương thức trả về giá trị captcha dưới dạng một chuỗi (kiểu String) bằng cách chuyển đổi giá trị số nguyên thành chuỗi sử dụng phương thức valueOf()
    }
